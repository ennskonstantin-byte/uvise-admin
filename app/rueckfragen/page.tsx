...
// Rückfragen -- 3-Ebenen-Navigation wie in der App
// (chef/components/RueckfragenScreen.tsx: "Sortierung: Mitarbeiter →
// Unterweisung → Chat"), statt einer flachen Liste aller Threads gemischt
// untereinander. Ebene 1: Mitarbeiter mit Rückfragen (Tab Offen/Alle +
// Suche). Ebene 2: dessen Unterweisungen mit Rückfragen. Ebene 3: der
// eigentliche Chat.
...
export default function RueckfragenPage() {
  ...
  // ————— Ebene 2: Unterweisungen dieses Mitarbeiters —————
  if (employeeId) {
