...
// Exportiert, damit lib/sifaCompanyData.tsx (SiFa-Mehrfirmen-Anbindung,
// Web-Port von Phase 5) denselben Context lokal mit firmen-gescopten Daten
// überschreiben kann -- jede Seite/jedes Modal, das useAppData() aufruft,
// funktioniert dadurch unverändert auch unter einem SifaCompanyDataProvider.
