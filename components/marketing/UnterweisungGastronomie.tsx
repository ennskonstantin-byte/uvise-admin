...
const GEFAEHRDUNGEN = [
  {
    ...
    title: "Schnittverletzungen",
    text: "Messer, Aufschnittmaschinen und andere Küchengeräte zählen zu den häufigsten Unfallursachen in der Gastronomie.",
  },
  {
    icon: Flame,
    title: "Verbrennungen & heißes Fett",
    text: "Fritteusen, Herde und Öfen bergen Verbrennungsgefahr — besonders bei Fettbränden, die sich anders löschen lassen als normale Brände.",
  },
  {
    icon: Footprints,
    title: "Rutschgefahr",
    text: "Nasse, fettige Böden in der Küche sind eine der häufigsten Ursachen für Stürze und Ausrutscher.",
  },
  {
    icon: Droplet,
    title: "Reinigungschemikalien",
    text: "Reinigungs- und Desinfektionsmittel gelten arbeitsschutzrechtlich als Gefahrstoffe — Hautkontakt und Dämpfe können gesundheitsschädlich sein.",
  },
];

const UNTERWEISUNGEN = [
  "Sicherheitsunterweisung Küche: Umgang mit Messern, Aufschnitt- und Küchenmaschinen",
  "Gefahrstoffunterweisung zu Reinigungs- und Desinfektionsmitteln",
  "Brandschutzunterweisung mit Fokus auf Fettbrände und den richtigen Feuerlöscher",
  "Verhalten bei Verbrennungen und Erste-Hilfe-Grundlagen in der Küche",
];
...
export function UnterweisungGastronomie({ faq }: { faq: FaqItem[] }) {
  ...
  return (
    <div className="uv-mk min-h-screen overflow-x-hidden">
      <TrackPageView path="/unterweisung-gastronomie" />
      <AffiliateRef />
      <header
      ...
      >
        <div className="mx-auto max-w-6xl px-5 sm:px-8 h-16 flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center gap-8 text-sm text-[var(--mk-ink-70)]">
            ...
            <a href="#hygiene-abgrenzung" className="whitespace-nowrap hover:text-[var(--mk-ink)]">Lebensmittelhygiene</a>
      ...
      >
        ...
        <nav className="flex flex-col gap-1">
          ...
          <a href="#hygiene-abgrenzung" onClick={() => setMenuOpen(false)} className="rounded-[8px] px-3 py-3 text-sm font-medium text-[var(--mk-ink-70)]">
            Lebensmittelhygiene
          </a>
      ...
      <main id="top">
            ...
            >
              <Breadcrumbs
                items={[
                  ...
                  { label: "Unterweisung Gastronomie" },
                ]}
              ...
              />
              <PlacardTag>
                <UtensilsCrossed size={13} /> Für Gastronomie & Küchen
              </PlacardTag>
              <h1
                className="mk-display font-bold tracking-[-0.03em] leading-[1.04] mt-7 mb-6"
                style={{ fontSize: "clamp(2.25rem, 3.8vw, 3.25rem)" }}
              >
                Unterweisung in der Gastronomie,{" "}
                <span style={{ color: "var(--mk-blue)" }}>auch bei hoher Fluktuation im Griff.</span>
              </h1>
              <p className="text-lg text-[var(--mk-ink-65)] mb-9 max-w-md leading-relaxed">
                Aushilfen, Saisonkräfte, gemischte Teams — und ständig wechselndes Personal in
                Küche und Service. uVise übernimmt Fristen, Nachweise und die verständliche
                Vermittlung in 41 Sprachen.
              </p>
        ...
        <section id="gefaehrdungen" className="scroll-mt-16">
          ...
          <div className="mx-auto max-w-6xl px-5 sm:px-8 py-28 sm:py-32">
            <Reveal className="max-w-xl mb-12">
              <h2 className="mk-display text-3xl font-bold mb-3">Typische Gefährdungen in der Gastronomie</h2>
              <p className="text-[var(--mk-ink-65)]">
                Welche Gefährdungen konkret relevant sind, ergibt sich aus der Gefährdungsbeurteilung
                des jeweiligen Betriebs — häufig wiederkehrend sind:
              </p>
            </Reveal>
          ...
          <div className="mx-auto max-w-3xl px-5 sm:px-8 py-28 sm:py-32">
            <Reveal>
              <h2 className="mk-display text-3xl font-bold mb-6">
                Welche Unterweisungen in der Gastronomie nötig sind
              </h2>
              ...
              <p className="text-[var(--mk-ink-65)] leading-relaxed">
                Rechtliche Grundlage ist § 12 ArbSchG in Verbindung mit § 4 DGUV Vorschrift 1 —
                ...
                . Reinigungsmittel gelten arbeitsschutzrechtlich als Gefahrstoffe, mehr dazu in{" "}
                <Link
                ...
                , zum Brandschutz mehr in{" "}
                <Link
                  href="/ratgeber/brandschutzunterweisung"
                  className="underline hover:no-underline"
                  style={{ color: "var(--mk-blue)" }}
                >
                  Brandschutzunterweisung: Pflicht, Inhalte und Häufigkeit
                </Link>
                . Zuständig für die meisten Gastronomiebetriebe ist die{" "}
                <a
                  href="https://www.bgn.de"
                  target="_blank"
        ...
        {/* Abgrenzung Lebensmittelhygiene */}
        <section id="hygiene-abgrenzung" className="scroll-mt-16">
          <SignalRule />
          <div className="mx-auto max-w-3xl px-5 sm:px-8 py-28 sm:py-32">
            <Reveal>
              <div className="rounded-[14px] border p-7" style={{ borderColor: "var(--mk-line)", background: "var(--mk-panel)" }}>
                <h2 className="mk-display text-2xl font-bold mb-3">
                  Wichtig: Das ist nicht die Lebensmittelhygiene-Belehrung
                </h2>
                <p className="text-[var(--mk-ink-65)] leading-relaxed mb-3">
                  Häufig werden zwei unterschiedliche Pflichten verwechselt. Die{" "}
                  <a
                  ...
                  erfolgt einmalig durch das Gesundheitsamt (oder online mit anschließender
                  behördlicher Bestätigung) und betrifft die Lebensmittelhygiene — den Schutz der
                  Gäste vor Infektionskrankheiten.
                </p>
                <p className="text-[var(--mk-ink-65)] leading-relaxed">
                  Die <strong>Arbeitsschutz-Unterweisung</strong> nach § 12 ArbSchG betrifft dagegen
                  die Sicherheit der Beschäftigten selbst — Schnittverletzungen, Verbrennungen,
                  Rutschgefahr. uVise deckt die Arbeitsschutz-Unterweisung ab; die
                  Lebensmittelhygiene-Belehrung bleibt weiterhin separat beim Gesundheitsamt zu
                  organisieren.
                </p>
              </div>
            </Reveal>
          ...
          <div className="mx-auto max-w-6xl px-5 sm:px-8 grid lg:grid-cols-2 gap-14 items-center py-28 sm:py-32">
            <Reveal>
              ...
              <h2 className="mk-display text-3xl sm:text-4xl font-bold mb-4 mt-5 leading-tight">
                Gastro-Teams wechseln oft und sind gemischt besetzt
              </h2>
              <p className="text-[var(--mk-ink-65)] mb-6 max-w-md">
                Hohe Fluktuation, viele Aushilfen und international besetzte Teams sind in der
                Gastronomie die Regel, nicht die Ausnahme. Eine Unterschrift unter einem deutschen
                Text reicht rechtlich nicht, wenn erkennbar ist, dass jemand kaum Deutsch spricht.
              </p>
              <p className="text-[var(--mk-ink-65)] mb-6 max-w-md">
        ...
        <section className="scroll-mt-16">
          ...
          <div className="mx-auto max-w-3xl px-5 sm:px-8 py-28 sm:py-32">
            <Reveal>
              <div className="rounded-[14px] border p-7" style={{ borderColor: "var(--mk-line)", background: "var(--mk-panel)" }}>
                <h2 className="mk-display text-2xl font-bold mb-3">Wie uVise in der Gastronomie hilft</h2>
                <p className="text-[var(--mk-ink-65)] mb-4 leading-relaxed">
                  uVise erinnert automatisch an fällige Unterweisungen, weist neue Aushilfen in
                  Minuten ein und sammelt die Unterschrift jedes Mitarbeiters rechtssicher mit
                  Zeitstempel — auch bei kurzfristigen Saisonkräften bleibt der Nachweis vollständig.
                </p>
                <Link
                  href="/login?mode=register"
                  rel="nofollow"
        ...
        <section id="faq" className="scroll-mt-16">
          ...
          <div className="mx-auto max-w-3xl px-5 sm:px-8 py-28 sm:py-32">
            <Reveal className="mb-10">
              ...
              <p className="text-[var(--mk-ink-65)]">Zur Unterweisung in Gastronomiebetrieben.</p>
            </Reveal>
        ...
        <section>
          ...
          <Reveal className="mx-auto max-w-3xl px-5 sm:px-8 py-28 sm:py-32 text-center">
            <h2 className="mk-display text-3xl font-bold mb-4">
              Unterweisungen, die auch bei hoher Fluktuation funktionieren
            </h2>
