...
const GEFAEHRDUNGEN = [
  {
    ...
    text: "Gabelstapler und andere Flurförderzeuge im innerbetrieblichen Verkehr — Anfahr-, Umkipp- und Quetschgefahr.",
  },
  {
    icon: Layers,
    title: "Regalanlagen",
    text: "Anfahrschäden an Regalen können die Standsicherheit gefährden, wenn sie nicht erkannt und gemeldet werden.",
  },
  {
    icon: PackageOpen,
    title: "Ladungssicherung",
    text: "Unzureichend gesicherte Ladung kann beim Transport verrutschen oder herabfallen — Gefahr für Fahrer und Umstehende.",
  },
  {
    icon: Warehouse,
    title: "Heben & Tragen",
    text: "Manuelles Heben schwerer Kartons und Pakete belastet die Wirbelsäule, wenn keine Hebehilfen genutzt werden.",
  },
];

const UNTERWEISUNGEN = [
  "Jährliche Unterweisung aller Staplerfahrer, zusätzlich zur Fahrerlaubnis nach DGUV Grundsatz 308-001",
  "Schriftliche Beauftragung jedes Fahrers für den jeweiligen Betrieb und das jeweilige Fahrzeug",
  "Verhalten bei Anfahrschäden an Regalanlagen: sofortige Meldung, Absperrung",
  "Unterweisung zur Ladungssicherung nach den Grundregeln der Verkehrssicherheit",
  "Rückenschonendes Heben und Tragen sowie Nutzung vorhandener Hebehilfen",
];
...
// Landingpage für Lager- und Logistikbetriebe — gleiche Bausteine, Farben
// (--mk-*-Variablen) und Hell/Dunkel-Support wie die Startseite und
// /unterweisung-handwerk, eigener, branchenspezifischer Inhalt.
export function UnterweisungLagerLogistik({ faq }: { faq: FaqItem[] }) {
  ...
  return (
    <div className="uv-mk min-h-screen overflow-x-hidden">
      <TrackPageView path="/unterweisung-lager-logistik" />
      <AffiliateRef />
      <header
            ...
            >
              <Breadcrumbs
                items={[
                  ...
                  { label: "Unterweisung Lager & Logistik" },
                ]}
              ...
              />
              <PlacardTag>
                <Warehouse size={13} /> Für Lager & Logistik
              </PlacardTag>
              <h1
                className="mk-display font-bold tracking-[-0.03em] leading-[1.04] mt-7 mb-6"
                style={{ fontSize: "clamp(2.25rem, 3.8vw, 3.25rem)" }}
              >
                Unterweisung in Lager & Logistik,{" "}
                <span style={{ color: "var(--mk-blue)" }}>vom Stapler bis zur Ladungssicherung.</span>
              </h1>
              <p className="text-lg text-[var(--mk-ink-65)] mb-9 max-w-md leading-relaxed">
                Flurförderzeuge, Regalanlagen und ständig wechselnde Aushilfen im Lager — uVise
                übernimmt Fristen, Nachweise und die verständliche Vermittlung in 41 Sprachen.
              </p>
        ...
        <section id="gefaehrdungen" className="scroll-mt-16">
          ...
          <div className="mx-auto max-w-6xl px-5 sm:px-8 py-28 sm:py-32">
            <Reveal className="max-w-xl mb-12">
              <h2 className="mk-display text-3xl font-bold mb-3">Typische Gefährdungen in Lager & Logistik</h2>
              <p className="text-[var(--mk-ink-65)]">
                Welche Gefährdungen konkret relevant sind, ergibt sich aus der Gefährdungsbeurteilung
                des jeweiligen Lagers — häufig wiederkehrend sind:
              </p>
            </Reveal>
          ...
          <div className="mx-auto max-w-3xl px-5 sm:px-8 py-28 sm:py-32">
            <Reveal>
              <h2 className="mk-display text-3xl font-bold mb-6">
                Welche Unterweisungen in Lager & Logistik nötig sind
              </h2>
              ...
              <p className="text-[var(--mk-ink-65)] leading-relaxed">
                Für Flurförderzeuge gilt{" "}
                <a
                  href="https://publikationen.dguv.de/regelwerk/dguv-vorschriften/1123/flurfoerderzeuge"
                  target="_blank"
                ...
                in Verbindung mit{" "}
                <a
                  href="https://publikationen.dguv.de/regelwerk/dguv-grundsaetze/48/qualifizierung-und-beauftragung-der-fahrerinnen-und-fahrer-von-flurfoerderzeugen-ausser-gelaendegaengige"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="underline hover:no-underline"
                  style={{ color: "var(--mk-blue)" }}
                ...
                . Die allgemeine jährliche Unterweisungspflicht ergibt sich wie überall aus § 4 DGUV
                Vorschrift 1 — Details dazu in unserem Ratgeber{" "}
                <Link
                ...
                . Zuständig für die meisten Lager- und Logistikbetriebe ist die{" "}
                <a
                  href="https://www.bghw.de"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="underline hover:no-underline"
                  style={{ color: "var(--mk-blue)" }}
          ...
          <div className="mx-auto max-w-6xl px-5 sm:px-8 grid lg:grid-cols-2 gap-14 items-center py-28 sm:py-32">
            <Reveal>
              ...
              <h2 className="mk-display text-3xl sm:text-4xl font-bold mb-4 mt-5 leading-tight">
                Lagerteams wechseln oft und sind gemischt besetzt
              </h2>
              <p className="text-[var(--mk-ink-65)] mb-6 max-w-md">
                Saisonale Aushilfen, Zeitarbeit und internationale Teams sind in Lager und Logistik
                die Regel. Gerade bei Staplerfahrern muss die Unterweisung tatsächlich verstanden
                werden — eine bloße Unterschrift reicht rechtlich nicht.
              </p>
              <p className="text-[var(--mk-ink-65)] mb-6 max-w-md">
          ...
          <div className="mx-auto max-w-3xl px-5 sm:px-8 py-28 sm:py-32">
            <Reveal>
              <div className="rounded-[14px] border p-7" style={{ borderColor: "var(--mk-line)", background: "var(--mk-panel)" }}>
                <h2 className="mk-display text-2xl font-bold mb-3">Wie uVise in Lager & Logistik hilft</h2>
                <p className="text-[var(--mk-ink-65)] mb-4 leading-relaxed">
                  uVise erinnert automatisch an fällige Unterweisungen für Staplerfahrer und alle
                  anderen Beschäftigten, sammelt die Unterschrift rechtssicher mit Zeitstempel und
                  legt den Nachweis unveränderbar im Archiv ab — auch bei kurzfristigen Aushilfen.
                </p>
                <Link
                  href="/login?mode=register"
                  rel="nofollow"
        ...
        <section id="faq" className="scroll-mt-16">
          ...
          <div className="mx-auto max-w-3xl px-5 sm:px-8 py-28 sm:py-32">
            <Reveal className="mb-10">
              ...
              <p className="text-[var(--mk-ink-65)]">Zur Unterweisung in Lager- und Logistikbetrieben.</p>
            </Reveal>
        ...
        <section>
          ...
          <Reveal className="mx-auto max-w-3xl px-5 sm:px-8 py-28 sm:py-32 text-center">
            <h2 className="mk-display text-3xl font-bold mb-4">
              Unterweisungen, die auch mit hoher Fluktuation funktionieren
            </h2>
