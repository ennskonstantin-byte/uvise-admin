...
// Mitarbeiter), aber "sprechender" als ein reiner Farbkreis: Hautton und
// Frisur variieren pro Person. Bewusst zurückhaltend gestaltet (schmale
// Augenstriche, kein breites Cartoon-Lächeln), damit es seriös statt
// verspielt wirkt.
...
function Hair({ variant, color }: { variant: number; color: string }) {
  switch (variant % 5) {
    ...
    default: // längeres Haar mit Seitenpartien
      return <path d="M12 44 L12 24 A24 24 0 0 1 60 24 L60 44 L54 44 L54 26 A18 18 0 0 0 18 26 L18 44 Z" fill={color} />;
  }
}
...
export function PersonAvatar({
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Schmale Augenstriche statt Punkten, kein Mund — wirkt neutral/seriös statt wie ein Cartoon-Smiley */}
      <path d="M22 37 L30 37" stroke="#2b2320" strokeWidth={2.5} strokeLinecap="round" />
      <path d="M42 37 L50 37" stroke="#2b2320" strokeWidth={2.5} strokeLinecap="round" />
