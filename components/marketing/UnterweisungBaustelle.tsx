...
const GEFAEHRDUNGEN = [
  {
    icon: HardHat,
    title: "Absturz",
    text: "Arbeiten in der Höhe, auf Gerüsten, Dächern oder an offenen Kanten — eine der häufigsten Unfallursachen auf dem Bau.",
  },
  {
    icon: Construction,
    title: "Gräben & Erdarbeiten",
    text: "Einstürzende Grubenwände und Verschüttungsgefahr bei ungesicherten Baugruben und Leitungsgräben.",
  },
  {
    icon: Truck,
    title: "Baumaschinen",
    text: "Bagger, Kräne und Fahrzeuge im Rückraumbereich — Quetsch- und Anfahrgefahr bei unübersichtlichem Baustellenverkehr.",
  },
  {
    icon: Volume2,
    title: "Lärm",
    text: "Presslufthammer, Kreissäge und Bohrhammer belasten das Gehör dauerhaft, wenn kein Gehörschutz getragen wird.",
  },
  {
    icon: Wind,
    title: "Quarzstaub & Gefahrstoffe",
    text: "Betonstaub beim Schneiden und Bohren kann zu Silikose führen — ebenso Lösungsmittel, Kleber und Beschichtungen.",
  },
];

const UNTERWEISUNGEN = [
  "Baustellenbezogene Erstunterweisung vor dem ersten Betreten — Fluchtwege, Gefahrenbereiche, Ansprechpartner",
  "PSA gegen Absturz: Anschlagpunkte, Auffanggurt, Verhalten bei Arbeiten in der Höhe",
  "Gerüst- und Leiternutzung: zulässige Belastung, sichere Aufstellung",
  "Bedienung und sicherer Umgang mit Baumaschinen und Fahrzeugen",
  "Gefahrstoffunterweisung bei Staub, Klebern und Beschichtungen",
  "Brandschutzunterweisung bei Schweiß-, Trenn- und Heißarbeiten",
];
...
// Landingpage für die Baubranche — gleiche Bausteine, Farben (--mk-*-Variablen)
// und Hell/Dunkel-Support wie die Startseite und /unterweisung-handwerk
// (components/marketing/MarketingHome.tsx, UnterweisungHandwerk.tsx), eigener,
// branchenspezifischer Inhalt.
export function UnterweisungBaustelle({ faq }: { faq: FaqItem[] }) {
  ...
  return (
    <div className="uv-mk min-h-screen overflow-x-hidden">
      <TrackPageView path="/unterweisung-baustelle" />
      <AffiliateRef />
      <header
        ...
        <section className="scroll-mt-16 relative">
          ...
          <div className="relative mx-auto max-w-6xl px-5 sm:px-8 pt-20 sm:pt-28 pb-24 sm:pb-32 grid lg:grid-cols-2 gap-14 items-center">
            ...
            >
              ...
              />
              <PlacardTag>
                <HardHat size={13} /> Für Bau & Gewerke
              </PlacardTag>
              <h1
              ...
              >
                ...
                <span style={{ color: "var(--mk-blue)" }}>verständlich für jedes Team.</span>
              </h1>
              <p className="text-lg text-[var(--mk-ink-65)] mb-9 max-w-md leading-relaxed">
                Wechselnde Baustellen, wechselnde Gewerke, oft mehrere Fremdfirmen gleichzeitig —
                und ein hoher Anteil fremdsprachiger Kollegen. uVise übernimmt Fristen, Nachweise
                und die verständliche Vermittlung in 41 Sprachen.
              </p>
        ...
        <section id="gefaehrdungen" className="scroll-mt-16">
          ...
          <div className="mx-auto max-w-6xl px-5 sm:px-8 py-28 sm:py-32">
            <Reveal className="max-w-xl mb-12">
              <h2 className="mk-display text-3xl font-bold mb-3">Typische Gefährdungen auf der Baustelle</h2>
              <p className="text-[var(--mk-ink-65)]">
                Welche Gefährdungen konkret relevant sind, ergibt sich aus der Gefährdungsbeurteilung
                des jeweiligen Bauvorhabens — häufig wiederkehrend sind:
              </p>
            </Reveal>
          ...
          <div className="mx-auto max-w-3xl px-5 sm:px-8 py-28 sm:py-32">
            <Reveal>
              <h2 className="mk-display text-3xl font-bold mb-6">
                Welche Unterweisungen auf der Baustelle nötig sind
              </h2>
              ...
              <p className="text-[var(--mk-ink-65)] leading-relaxed">
                Rechtliche Grundlage ist § 12 ArbSchG in Verbindung mit § 4 DGUV Vorschrift 1 — Details
                ...
                . Bei Gefahrstoffen wie Baustaub oder Beschichtungen gilt zusätzlich § 14 GefStoffV,
                mehr dazu in{" "}
                <Link
                ...
                . Zuständig für die meisten Baubetriebe ist die{" "}
                <a
          ...
          <div className="mx-auto max-w-6xl px-5 sm:px-8 grid lg:grid-cols-2 gap-14 items-center py-28 sm:py-32">
            <Reveal>
              ...
              <h2 className="mk-display text-3xl sm:text-4xl font-bold mb-4 mt-5 leading-tight">
                Baustellenteams sind selten einsprachig
              </h2>
              <p className="text-[var(--mk-ink-65)] mb-6 max-w-md">
                Auf vielen Baustellen arbeiten Kollegen aus unterschiedlichen Ländern zusammen —
                gerade bei Fremdfirmen und Subunternehmern. Eine Unterschrift unter einem deutschen
          ...
          <div className="mx-auto max-w-3xl px-5 sm:px-8 py-28 sm:py-32">
            <Reveal>
              <div className="rounded-[14px] border p-7" style={{ borderColor: "var(--mk-line)", background: "var(--mk-panel)" }}>
                <h2 className="mk-display text-2xl font-bold mb-3">Wie uVise auf der Baustelle hilft</h2>
                <p className="text-[var(--mk-ink-65)] mb-4 leading-relaxed">
                  ...
                  jedes Mitarbeiters rechtssicher mit Zeitstempel — direkt auf dem Handy, auch ohne
                  Netzabdeckung auf der Baustelle — und legt den Nachweis unveränderbar im Archiv ab.
                </p>
                <Link
                  href="/login?mode=register"
                  rel="nofollow"
        ...
        <section id="faq" className="scroll-mt-16">
          ...
          <div className="mx-auto max-w-3xl px-5 sm:px-8 py-28 sm:py-32">
            <Reveal className="mb-10">
              ...
              <p className="text-[var(--mk-ink-65)]">Zur Unterweisung auf der Baustelle.</p>
            </Reveal>
        ...
        <section>
          ...
          <Reveal className="mx-auto max-w-3xl px-5 sm:px-8 py-28 sm:py-32 text-center">
            <h2 className="mk-display text-3xl font-bold mb-4">
              Unterweisungen, die auf jeder Baustelle ankommen
            </h2>
