...
const GEFAEHRDUNGEN = [
  {
    icon: Flame,
    title: "Heißarbeiten",
    text: "Löten und Schweißen können brennbare Materialien in der Umgebung entzünden — besonders in fremden Gebäuden ohne Brandschutzeinrichtungen.",
  },
  {
    icon: Wind,
    title: "Arbeiten an Gasanlagen",
    text: "Explosions- und Vergiftungsgefahr bei unsachgemäßem Umgang mit gasführenden Leitungen und Anlagen.",
  },
  {
    icon: Wrench,
    title: "Absturz auf Dächern & Leitern",
    text: "Montage von Heizungs- und Lüftungstechnik findet häufig auf Dächern, Gerüsten oder Leitern statt.",
  },
  {
    icon: Droplet,
    title: "Gefahrstoffe",
    text: "Lötpasten, Dichtmittel und Reiniger können gesundheitsschädlich sein und erfordern eine gesonderte Unterweisung.",
  },
  {
    icon: Layers,
    title: "Asbest im Altbaubestand",
    text: "Ältere Rohrisolierungen, Dichtungen oder Bodenbeläge können Asbestfasern enthalten — vor Arbeiten im Altbau prüfen.",
  },
];

const UNTERWEISUNGEN = [
  "Unterweisung zu Heißarbeiten inklusive Erlaubnisschein für feuergefährliche Arbeiten",
  "Unterweisung zu Arbeiten an Gasanlagen und den betriebsspezifischen Absperr- und Prüfschritten",
  "PSA gegen Absturz bei Arbeiten auf Dächern, Gerüsten und Leitern",
  "Gefahrstoffunterweisung zu Lötpasten, Dichtmitteln und Reinigern",
  "Verhalten bei Verdacht auf Asbest im Altbaubestand",
];
...
// Landingpage für SHK-Betriebe (Sanitär, Heizung, Klima) — gleiche Bausteine,
// Farben (--mk-*-Variablen) und Hell/Dunkel-Support wie die Startseite und
// /unterweisung-handwerk, eigener, branchenspezifischer Inhalt.
export function UnterweisungShk({ faq }: { faq: FaqItem[] }) {
  ...
  return (
    <div className="uv-mk min-h-screen overflow-x-hidden">
      <TrackPageView path="/unterweisung-shk" />
      <AffiliateRef />
      <header
        ...
        <section className="scroll-mt-16 relative">
          ...
          <div className="relative mx-auto max-w-6xl px-5 sm:px-8 pt-20 sm:pt-28 pb-24 sm:pb-32 grid lg:grid-cols-2 gap-14 items-center">
            ...
            >
              ...
              />
              <PlacardTag>
                <Wrench size={13} /> Für Sanitär, Heizung & Klima
              </PlacardTag>
              <h1
                className="mk-display font-bold tracking-[-0.03em] leading-[1.04] mt-7 mb-6"
                style={{ fontSize: "clamp(2.25rem, 3.8vw, 3.25rem)" }}
              >
                Unterweisung im SHK-Handwerk,{" "}
                <span style={{ color: "var(--mk-blue)" }}>von Heißarbeiten bis Altbau.</span>
              </h1>
              <p className="text-lg text-[var(--mk-ink-65)] mb-9 max-w-md leading-relaxed">
                Löten, Gasanlagen, Dacharbeiten und der Umgang mit Altbaubestand — uVise
        ...
        <section id="gefaehrdungen" className="scroll-mt-16">
          ...
          <div className="mx-auto max-w-6xl px-5 sm:px-8 py-28 sm:py-32">
            <Reveal className="max-w-xl mb-12">
              <h2 className="mk-display text-3xl font-bold mb-3">Typische Gefährdungen im SHK-Handwerk</h2>
              <p className="text-[var(--mk-ink-65)]">
                Welche Gefährdungen konkret relevant sind, ergibt sich aus der Gefährdungsbeurteilung
                des jeweiligen Einsatzortes — häufig wiederkehrend sind:
              </p>
            </Reveal>
          ...
          <div className="mx-auto max-w-3xl px-5 sm:px-8 py-28 sm:py-32">
            <Reveal>
              <h2 className="mk-display text-3xl font-bold mb-6">
                Welche Unterweisungen im SHK-Handwerk nötig sind
              </h2>
              ...
              <p className="text-[var(--mk-ink-65)] leading-relaxed">
                ...
                . Für Heißarbeiten gilt zusätzlich der Grundschutz aus{" "}
                <Link
                ...
                . Zuständig ist je nach Tätigkeitsschwerpunkt meist die{" "}
                <a
                ...
                , bei stark baustellenbezogenen Tätigkeiten teils auch die BG BAU.
              </p>
            </Reveal>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-6xl px-5 sm:px-8 grid lg:grid-cols-2 gap-14 items-center py-28 sm:py-32">
            <Reveal>
              ...
              <h2 className="mk-display text-3xl sm:text-4xl font-bold mb-4 mt-5 leading-tight">
                Auch SHK-Teams sind oft international besetzt
              </h2>
              <p className="text-[var(--mk-ink-65)] mb-6 max-w-md">
                Gerade bei sicherheitskritischen Themen wie Heißarbeiten oder Gasanlagen muss die
                Unterweisung tatsächlich verstanden werden — nicht nur unterschrieben.
              </p>
              <p className="text-[var(--mk-ink-65)] mb-6 max-w-md">
          ...
          <div className="mx-auto max-w-3xl px-5 sm:px-8 py-28 sm:py-32">
            <Reveal>
              <div className="rounded-[14px] border p-7" style={{ borderColor: "var(--mk-line)", background: "var(--mk-panel)" }}>
                <h2 className="mk-display text-2xl font-bold mb-3">Wie uVise im SHK-Handwerk hilft</h2>
                <p className="text-[var(--mk-ink-65)] mb-4 leading-relaxed">
                  ...
                  jedes Mitarbeiters rechtssicher mit Zeitstempel — direkt auf dem Handy, auch
                  unterwegs auf der Baustelle — und legt den Nachweis unveränderbar im Archiv ab.
                </p>
                <Link
                  href="/login?mode=register"
                  rel="nofollow"
        ...
        <section id="faq" className="scroll-mt-16">
          ...
          <div className="mx-auto max-w-3xl px-5 sm:px-8 py-28 sm:py-32">
            <Reveal className="mb-10">
              ...
              <p className="text-[var(--mk-ink-65)]">Zur Unterweisung im SHK-Handwerk.</p>
            </Reveal>
        ...
        <section>
          ...
          <Reveal className="mx-auto max-w-3xl px-5 sm:px-8 py-28 sm:py-32 text-center">
            <h2 className="mk-display text-3xl font-bold mb-4">
              Unterweisungen, die im SHK-Alltag ankommen
            </h2>
