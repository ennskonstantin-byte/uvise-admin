...
const GEFAEHRDUNGEN = [
  {
    icon: Zap,
    title: "Stromschlag",
    text: "Berühren aktiver, unter Spannung stehender Teile — schon geringe Ströme können lebensgefährlich sein.",
  },
  {
    icon: ShieldAlert,
    title: "Lichtbogen",
    text: "Ein Störlichtbogen bei Kurzschluss erzeugt extreme Hitze in Sekundenbruchteilen — Verbrennungsgefahr auch ohne direkten Kontakt.",
  },
  {
    icon: FlaskConical,
    title: "Arbeiten unter Spannung",
    text: "Ohne vollständige Freischaltung steigt das Risiko deutlich — Ausnahme nur mit besonderer Qualifikation und Schutzmaßnahmen.",
  },
  {
    icon: ClipboardCheck,
    title: "Beschädigte Betriebsmittel",
    text: "Defekte Kabel, Stecker oder Gehäuse an ortsveränderlichen Geräten bleiben ohne regelmäßige Prüfung oft unentdeckt.",
  },
];
...
export function UnterweisungElektro({ faq }: { faq: FaqItem[] }) {
  ...
  return (
    <div className="uv-mk min-h-screen overflow-x-hidden">
      <TrackPageView path="/unterweisung-elektro" />
      <AffiliateRef />
      <header
      ...
      >
        <div className="mx-auto max-w-6xl px-5 sm:px-8 h-16 flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center gap-8 text-sm text-[var(--mk-ink-70)]">
            ...
            <a href="#sicherheitsregeln" className="whitespace-nowrap hover:text-[var(--mk-ink)]">5 Sicherheitsregeln</a>
      ...
      >
        ...
        <nav className="flex flex-col gap-1">
          ...
          <a href="#sicherheitsregeln" onClick={() => setMenuOpen(false)} className="rounded-[8px] px-3 py-3 text-sm font-medium text-[var(--mk-ink-70)]">
            5 Sicherheitsregeln
          </a>
      ...
      <main id="top">
        ...
        <section className="scroll-mt-16 relative">
          ...
          <div className="relative mx-auto max-w-6xl px-5 sm:px-8 pt-20 sm:pt-28 pb-24 sm:pb-32 grid lg:grid-cols-2 gap-14 items-center">
            ...
            >
              ...
              />
              <PlacardTag>
                <Zap size={13} /> Für Elektrofachbetriebe
              </PlacardTag>
              <h1
                className="mk-display font-bold tracking-[-0.03em] leading-[1.04] mt-7 mb-6"
                style={{ fontSize: "clamp(2.25rem, 3.8vw, 3.25rem)" }}
              >
                Unterweisung im Elektrohandwerk,{" "}
                <span style={{ color: "var(--mk-blue)" }}>EUP und Elektrofachkraft sauber getrennt.</span>
              </h1>
              <p className="text-lg text-[var(--mk-ink-65)] mb-9 max-w-md leading-relaxed">
                Elektrofachkraft, elektrotechnisch unterwiesene Person, die 5 Sicherheitsregeln,
                Prüffristen nach DGUV Vorschrift 3 — uVise hält die Fristen im Blick und
                dokumentiert jede Unterweisung rechtssicher.
              </p>
        ...
        <section id="gefaehrdungen" className="scroll-mt-16">
          ...
          <div className="mx-auto max-w-6xl px-5 sm:px-8 py-28 sm:py-32">
            <Reveal className="max-w-xl mb-12">
              <h2 className="mk-display text-3xl font-bold mb-3">Typische Gefährdungen im Elektrohandwerk</h2>
              <p className="text-[var(--mk-ink-65)]">
                Elektrische Gefährdungen sind selten sichtbar — die Unterweisung ist deshalb
                besonders wichtig.
              </p>
            </Reveal>
        ...
        <section id="unterweisungen" className="scroll-mt-16">
          ...
          <div className="mx-auto max-w-3xl px-5 sm:px-8 py-28 sm:py-32">
            <Reveal>
              ...
              <p className="text-[var(--mk-ink-65)] mb-6 leading-relaxed">
                Die <strong>Elektrofachkraft (EFK)</strong> hat eine elektrotechnische Ausbildung und
                darf elektrische Anlagen eigenständig beurteilen, prüfen und instand setzen. Die{" "}
                <strong>elektrotechnisch unterwiesene Person (EUP)</strong> wurde von einer
                Elektrofachkraft über ihre konkrete Tätigkeit unterwiesen und darf nur einfache,
                genau festgelegte Arbeiten unter Anleitung ausführen — ohne eigene Gefährdungsbeurteilung.
                Beide benötigen eine dokumentierte Unterweisung, die typischerweise umfasst:
              </p>
              ...
              <p className="text-[var(--mk-ink-65)] leading-relaxed">
                Rechtliche Grundlage der jährlichen Unterweisungspflicht ist § 4 DGUV Vorschrift 1 —
                ...
                . Je nach Tätigkeitsschwerpunkt ist meist die BG ETEM oder eine andere
        ...
        {/* 5 Sicherheitsregeln */}
        <section id="sicherheitsregeln" className="scroll-mt-16">
          <SignalRule />
          <div className="mx-auto max-w-3xl px-5 sm:px-8 py-28 sm:py-32">
            <Reveal>
              <PlacardTag>
                <ShieldAlert size={13} /> Vor jeder Arbeit an elektrischen Anlagen
              </PlacardTag>
              <h2 className="mk-display text-3xl font-bold mb-6 mt-5">Die 5 Sicherheitsregeln</h2>
              <ol className="space-y-3 mb-6 list-decimal pl-5">
                <li className="text-[var(--mk-ink-70)]"><strong>Freischalten</strong> — die Anlage spannungsfrei schalten.</li>
                <li className="text-[var(--mk-ink-70)]"><strong>Gegen Wiedereinschalten sichern</strong> — z. B. durch Verriegelung oder Warnschild.</li>
                <li className="text-[var(--mk-ink-70)]"><strong>Spannungsfreiheit feststellen</strong> — mit einem geeigneten Prüfgerät.</li>
                <li className="text-[var(--mk-ink-70)]"><strong>Erden und kurzschließen</strong> — insbesondere bei höheren Spannungsebenen.</li>
                <li className="text-[var(--mk-ink-70)]"><strong>Benachbarte, unter Spannung stehende Teile abdecken oder abschranken</strong>.</li>
              </ol>
              <p className="text-[var(--mk-ink-65)] leading-relaxed">
                Diese Reihenfolge ist beim Ausschalten einzuhalten und in umgekehrter Reihenfolge
                beim Wiedereinschalten. Sie ist fester Bestandteil jeder Unterweisung im
                Elektrohandwerk und sollte regelmäßig praktisch geübt werden — mehr zum
                allgemeinen Ablauf einer Unterweisung in unserem Ratgeber{" "}
                <Link
          ...
          <div className="mx-auto max-w-3xl px-5 sm:px-8 py-28 sm:py-32">
            <Reveal>
              <div className="rounded-[14px] border p-7" style={{ borderColor: "var(--mk-line)", background: "var(--mk-panel)" }}>
                <h2 className="mk-display text-2xl font-bold mb-3">Wie uVise im Elektrohandwerk hilft</h2>
                <p className="text-[var(--mk-ink-65)] mb-4 leading-relaxed">
                  uVise erinnert automatisch an die jährliche Unterweisung von Elektrofachkräften
                  und EUP, sammelt die Unterschrift rechtssicher mit Zeitstempel und legt den
                  Nachweis unveränderbar im Archiv ab — startklar für die nächste Kontrolle. Auch
                  bei gemischten Teams: uVise übersetzt und liest jede Unterweisung zusätzlich in
                  41 Sprachen vor, mehr dazu unter{" "}
                  <Link
        ...
        <section id="faq" className="scroll-mt-16">
          ...
          <div className="mx-auto max-w-3xl px-5 sm:px-8 py-28 sm:py-32">
            <Reveal className="mb-10">
              ...
              <p className="text-[var(--mk-ink-65)]">Zur Unterweisung im Elektrohandwerk.</p>
            </Reveal>
