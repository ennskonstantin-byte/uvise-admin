...
const GEFAEHRDUNGEN = [
  {
    icon: Scissors,
    title: "Motorsäge & Freischneider",
    text: "Schnittverletzungen und Rückschlaggefahr gehören zu den schwersten Unfallrisiken im GaLaBau.",
  },
  {
    icon: TreeDeciduous,
    title: "Baumpflege & Absturz",
    text: "Arbeiten in der Krone oder auf der Hubarbeitsbühne bergen erhebliche Absturzgefahr.",
  },
  {
    icon: Volume2,
    title: "Lärm & Vibration",
    text: "Motorsägen, Freischneider und Rasenmäher belasten Gehör und Hände bei dauerhafter Nutzung.",
  },
  {
    icon: Sun,
    title: "UV-Belastung",
    text: "Arbeit im Freien über viele Stunden erhöht das Risiko für Hautschäden durch UV-Strahlung.",
  },
  {
    icon: Bug,
    title: "Zeckengefahr",
    text: "Regelmäßige Arbeit im Grünen erhöht das Risiko für Zeckenstiche und übertragbare Infektionen.",
  },
];

const UNTERWEISUNGEN = [
  "Motorsägenlehrgang vor der ersten Nutzung, zusätzlich zur jährlichen Unterweisung",
  "Sicherer Umgang mit Maschinen und Anbaugeräten (Freischneider, Häcksler, Kantenschneider)",
  "PSA gegen Absturz bei Baumpflege- und Höhenarbeiten",
  "Gehör- und Vibrationsschutz bei motorbetriebenen Geräten",
  "Verhalten zum Schutz vor UV-Belastung und Zeckenstichen",
];
...
// Landingpage für den Garten- und Landschaftsbau — gleiche Bausteine, Farben
// (--mk-*-Variablen) und Hell/Dunkel-Support wie die Startseite und
// /unterweisung-handwerk, eigener, branchenspezifischer Inhalt.
export function UnterweisungGalabau({ faq }: { faq: FaqItem[] }) {
  ...
  return (
    <div className="uv-mk min-h-screen overflow-x-hidden">
      <TrackPageView path="/unterweisung-galabau" />
      <AffiliateRef />
      <header
        ...
        <section className="scroll-mt-16 relative">
          ...
          <div className="relative mx-auto max-w-6xl px-5 sm:px-8 pt-20 sm:pt-28 pb-24 sm:pb-32 grid lg:grid-cols-2 gap-14 items-center">
            ...
            >
              ...
              />
              <PlacardTag>
                <TreeDeciduous size={13} /> Für Garten- & Landschaftsbau
              </PlacardTag>
              <h1
                className="mk-display font-bold tracking-[-0.03em] leading-[1.04] mt-7 mb-6"
                style={{ fontSize: "clamp(2.25rem, 3.8vw, 3.25rem)" }}
              >
                Unterweisung im GaLaBau,{" "}
                <span style={{ color: "var(--mk-blue)" }}>von der Motorsäge bis zur Baumpflege.</span>
              </h1>
              <p className="text-lg text-[var(--mk-ink-65)] mb-9 max-w-md leading-relaxed">
                Motorsägen, Maschinen und Arbeit im Freien bei jedem Wetter — uVise übernimmt
                Fristen, Nachweise und die verständliche Vermittlung, auch für Saisonkräfte.
              </p>
        ...
        <section id="gefaehrdungen" className="scroll-mt-16">
          ...
          <div className="mx-auto max-w-6xl px-5 sm:px-8 py-28 sm:py-32">
            <Reveal className="max-w-xl mb-12">
              <h2 className="mk-display text-3xl font-bold mb-3">Typische Gefährdungen im GaLaBau</h2>
              <p className="text-[var(--mk-ink-65)]">
                Welche Gefährdungen konkret relevant sind, ergibt sich aus der Gefährdungsbeurteilung
                des jeweiligen Auftrags — häufig wiederkehrend sind:
              </p>
            </Reveal>
          ...
          <div className="mx-auto max-w-3xl px-5 sm:px-8 py-28 sm:py-32">
            <Reveal>
              <h2 className="mk-display text-3xl font-bold mb-6">
                Welche Unterweisungen im GaLaBau nötig sind
              </h2>
              ...
              <p className="text-[var(--mk-ink-65)] leading-relaxed">
                ...
                . Zuständig für die meisten GaLaBau-Betriebe ist die{" "}
                <a
                  href="https://www.svlfg.de"
                  target="_blank"
                ...
                (Sozialversicherung für Landwirtschaft, Forsten und Gartenbau), hervorgegangen aus
                der früheren Gartenbau-Berufsgenossenschaft. Bei Betrieben mit starkem Schwerpunkt
                auf klassischen Bauleistungen kann teils auch die BG BAU relevant sein.
              </p>
            </Reveal>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-6xl px-5 sm:px-8 grid lg:grid-cols-2 gap-14 items-center py-28 sm:py-32">
            <Reveal>
              ...
              <h2 className="mk-display text-3xl sm:text-4xl font-bold mb-4 mt-5 leading-tight">
                Saisonkräfte im GaLaBau sind oft international
              </h2>
              <p className="text-[var(--mk-ink-65)] mb-6 max-w-md">
                Gerade in der Hochsaison arbeiten viele GaLaBau-Betriebe mit saisonalen und
                internationalen Kräften. Bei der Motorsäge oder Maschinenarbeit muss die
          ...
          <div className="mx-auto max-w-3xl px-5 sm:px-8 py-28 sm:py-32">
            <Reveal>
              <div className="rounded-[14px] border p-7" style={{ borderColor: "var(--mk-line)", background: "var(--mk-panel)" }}>
                <h2 className="mk-display text-2xl font-bold mb-3">Wie uVise im GaLaBau hilft</h2>
                <p className="text-[var(--mk-ink-65)] mb-4 leading-relaxed">
                  uVise erinnert automatisch an fällige Unterweisungen — auch kurz vor der
                  Saisonstart-Hochphase — sammelt die Unterschrift jedes Mitarbeiters rechtssicher
                  mit Zeitstempel und legt den Nachweis unveränderbar im Archiv ab.
                </p>
                <Link
                  href="/login?mode=register"
                  rel="nofollow"
        ...
        <section id="faq" className="scroll-mt-16">
          ...
          <div className="mx-auto max-w-3xl px-5 sm:px-8 py-28 sm:py-32">
            <Reveal className="mb-10">
              ...
              <p className="text-[var(--mk-ink-65)]">Zur Unterweisung im Garten- und Landschaftsbau.</p>
            </Reveal>
        ...
        <section>
          ...
          <Reveal className="mx-auto max-w-3xl px-5 sm:px-8 py-28 sm:py-32 text-center">
            <h2 className="mk-display text-3xl font-bold mb-4">
              Unterweisungen, die auch bei Saisonkräften ankommen
            </h2>
