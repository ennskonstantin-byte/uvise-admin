...
const GEFAEHRDUNGEN = [
  {
    icon: ArrowUpDown,
    title: "Hebebühnen",
    text: "Absturz von Fahrzeugen oder Personen bei unsachgemäßer Bedienung, Überlastung oder mangelnder Wartung.",
  },
  {
    icon: Car,
    title: "Reifen- & Radmontage",
    text: "Quetschgefahr an Reifenmontiermaschine und Auswuchtgerät, Berstgefahr bei zu hohem Reifendruck.",
  },
  {
    icon: Wind,
    title: "Abgase & Kohlenmonoxid",
    text: "Laufende Motoren in geschlossenen Werkstatthallen können zu gefährlichen CO-Konzentrationen führen.",
  },
  {
    icon: Volume2,
    title: "Lärm & Gefahrstoffe",
    text: "Druckluftwerkzeuge belasten das Gehör, Öle, Bremsflüssigkeit und Lacke gelten arbeitsschutzrechtlich als Gefahrstoffe.",
  },
  {
    icon: BatteryCharging,
    title: "Hochvolt-Systeme",
    text: "Elektro- und Hybridfahrzeuge führen hohe Spannungen — Arbeiten daran erfordern eine besondere Qualifizierung.",
  },
];
...
export function UnterweisungKfz({ faq }: { faq: FaqItem[] }) {
  ...
  return (
    <div className="uv-mk min-h-screen overflow-x-hidden">
      <TrackPageView path="/unterweisung-kfz" />
      <AffiliateRef />
      <header
      ...
      >
        <div className="mx-auto max-w-6xl px-5 sm:px-8 h-16 flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center gap-8 text-sm text-[var(--mk-ink-70)]">
            ...
            <a href="#hochvolt" className="whitespace-nowrap hover:text-[var(--mk-ink)]">Hochvolt</a>
      ...
      >
        ...
        <nav className="flex flex-col gap-1">
          ...
          <a href="#hochvolt" onClick={() => setMenuOpen(false)} className="rounded-[8px] px-3 py-3 text-sm font-medium text-[var(--mk-ink-70)]">
            Hochvolt
          </a>
      ...
      <main id="top">
            ...
            >
              <Breadcrumbs
                items={[
                  ...
                  { label: "Unterweisung KFZ-Werkstatt" },
                ]}
              ...
              />
              <PlacardTag>
                <Car size={13} /> Für KFZ-Werkstätten
              </PlacardTag>
              <h1
              ...
              >
                ...
                <span style={{ color: "var(--mk-blue)" }}>von Hebebühne bis Hochvolt.</span>
              </h1>
              <p className="text-lg text-[var(--mk-ink-65)] mb-9 max-w-md leading-relaxed">
                Hebebühnen, Gefahrstoffe, immer mehr Elektro- und Hybridfahrzeuge mit
                Hochvolt-Technik — uVise übernimmt Fristen, Nachweise und die verständliche
                Vermittlung, auch bei gemischten Teams.
              </p>
        ...
        <section id="gefaehrdungen" className="scroll-mt-16">
          ...
          <div className="mx-auto max-w-6xl px-5 sm:px-8 py-28 sm:py-32">
            <Reveal className="max-w-xl mb-12">
              <h2 className="mk-display text-3xl font-bold mb-3">Typische Gefährdungen in der KFZ-Werkstatt</h2>
          ...
          <div className="mx-auto max-w-3xl px-5 sm:px-8 py-28 sm:py-32">
            <Reveal>
              ...
              <p className="text-[var(--mk-ink-65)] leading-relaxed">
                ...
                . Öle, Bremsflüssigkeit und Lacke gelten arbeitsschutzrechtlich als Gefahrstoffe,
                mehr dazu in{" "}
                <Link
                ...
                . Zuständig für die meisten KFZ-Betriebe ist die{" "}
                <a
                  href="https://www.bghm.de"
                  target="_blank"
        ...
        {/* Hochvolt */}
        <section id="hochvolt" className="scroll-mt-16">
          <SignalRule />
          <div className="mx-auto max-w-3xl px-5 sm:px-8 py-28 sm:py-32">
            <Reveal>
              <PlacardTag>
                <BatteryCharging size={13} /> Elektro- & Hybridfahrzeuge
              </PlacardTag>
              <h2 className="mk-display text-3xl font-bold mb-6 mt-5">
                Hochvolt-Qualifizierung: Stufe 1 bis 3
              </h2>
              <p className="text-[var(--mk-ink-65)] mb-4 leading-relaxed">
                Fahrzeuge mit Hochvolt-Systemen führen Spannungen, bei denen schon der bloße
                Kontakt lebensgefährlich sein kann.{" "}
                <a
                  href="https://publikationen.dguv.de/regelwerk/dguv-informationen/3982/qualifizierung-fuer-arbeiten-an-fahrzeugen-mit-hochvoltsystemen"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="underline hover:no-underline"
                  style={{ color: "var(--mk-blue)" }}
                ...
                unterscheidet drei aufeinander aufbauende Qualifizierungsstufen:
              </p>
              <ul className="space-y-3 mb-6">
                <li className="text-[var(--mk-ink-70)] text-sm">
                  <strong>Stufe 1</strong> — Grundwissen für Tätigkeiten ohne direkten Kontakt zu
                  Hochvolt-Komponenten, z. B. Wagenwäsche oder Reifenwechsel.
                </li>
                <li className="text-[var(--mk-ink-70)] text-sm">
                  <strong>Stufe 2</strong> — Arbeiten unter Anleitung einer Fachkraft für
                  festgelegte, wiederkehrende Tätigkeiten.
                </li>
                <li className="text-[var(--mk-ink-70)] text-sm">
                  <strong>Stufe 3</strong> — eigenständiges Arbeiten am Hochvolt-System, inklusive
                  Freischalten und Prüfen auf Spannungsfreiheit.
                </li>
              </ul>
              <p className="text-[var(--mk-ink-65)] leading-relaxed">
                Welche Stufe ein Mitarbeiter benötigt, ergibt sich aus seiner konkreten Tätigkeit —
                unabhängig davon bleibt die reguläre jährliche Unterweisung nach § 4 DGUV
                Vorschrift 1 Pflicht.
              </p>
            </Reveal>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-3xl px-5 sm:px-8 py-28 sm:py-32">
            <Reveal>
              <div className="rounded-[14px] border p-7" style={{ borderColor: "var(--mk-line)", background: "var(--mk-panel)" }}>
                <h2 className="mk-display text-2xl font-bold mb-3">Wie uVise in der KFZ-Werkstatt hilft</h2>
                <p className="text-[var(--mk-ink-65)] mb-4 leading-relaxed">
                  uVise erinnert automatisch an fällige Unterweisungen, sammelt die Unterschrift
                  jedes Mitarbeiters rechtssicher mit Zeitstempel und legt den Nachweis
                  unveränderbar im Archiv ab. Auch bei gemischten Teams: uVise übersetzt und liest
                  jede Unterweisung zusätzlich in 41 Sprachen vor, mehr dazu unter{" "}
                  <Link
        ...
        <section id="faq" className="scroll-mt-16">
          ...
          <div className="mx-auto max-w-3xl px-5 sm:px-8 py-28 sm:py-32">
            <Reveal className="mb-10">
              ...
              <p className="text-[var(--mk-ink-65)]">Zur Unterweisung in KFZ-Werkstätten.</p>
            </Reveal>
        ...
        <section>
          ...
          <Reveal className="mx-auto max-w-3xl px-5 sm:px-8 py-28 sm:py-32 text-center">
            <h2 className="mk-display text-3xl font-bold mb-4">
              Unterweisungen, die auch Hochvolt-Fahrzeuge abdecken
            </h2>
