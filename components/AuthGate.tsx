...
const PUBLIC_PATHS = ["/", "/impressum", "/datenschutz", "/agb", "/passwort-zuruecksetzen", "/kontakt", "/partner", "/ratgeber/unterweisung-vorlage", "/unterweisung-mehrsprachig"];
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-page-bg px-4">
        <div className="w-full max-w-sm rounded-[2rem] bg-background border border-border/60 shadow-sm p-8 text-center">
          ...
          <button
            onClick={async () => {
              // Harte Navigation statt router.push, siehe Sidebar.tsx: sonst
              // rendert diese noch aktive Seite kurz das Login-Formular,
              // bevor die Weiterleitung zur Startseite greift.
